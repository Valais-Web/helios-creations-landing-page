  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative min-h-screen">
        ...
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-[0.12]" style={{
          backgroundImage: `url(/lovable-uploads/7846f98d-2713-4494-9578-18e49b6fb101.png)`
        }} />
        <div className="absolute inset-0 bg-gradient-to-br from-background/85 via-background/92 to-background/95" />
